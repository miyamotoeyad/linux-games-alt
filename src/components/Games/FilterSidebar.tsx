...
export default function FilterSidebar() {
  ...
  return (
    <div className="w-full flex flex-col gap-6 md:gap-8">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between px-2">
          <div className="flex items-center gap-2 font-black uppercase tracking-[0.3em] text-zinc-500">
            <RiFilter3Line className="text-indigo-500" />
          ...
          {genres.map((genre) => {
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  <div
                    className={`w-1.5 h-1.5 rounded-full transition-all ${isActive ? "bg-white scale-125" : "bg-zinc-700 group-hover:bg-zinc-500"}`}
                  />
                  {genre}
                </div>
                {isActive && (
