...
export const metadata: Metadata = {
  ...
  description: "Connect with the Linux Games Alt community. Join our Discord Nexus for real-time game compatibility reports, community patches, and technical support.",
  openGraph: {
    title: "Contact Linux Games Alt",
    description: "Join the mission to bridge the gap between Windows and Linux gaming.",
  }
};
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-20">
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-xs font-bold uppercase tracking-widest text-indigo-400">Communication Channels</span>
            </div>
          ...
          >
            <div className="relative z-10 flex flex-col w-full items-center md:items-start text-center md:text-left">
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-xs font-black uppercase tracking-[0.3em] text-indigo-400">Official Server</span>
              </div>
              ...
              <p className="text-zinc-400 max-w-sm leading-relaxed mb-8">
                Direct access to the developers, community patches, and real-time compatibility reports for Linux gamers.
              </p>
            ...
            <RiDiscordFill size={300} className="absolute -right-20 -bottom-20 text-white/2 rotate-12 group-hover:rotate-6 transition-transform duration-700" />
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-8 rounded-3xl bg-white/2 border border-white/5 hover:border-white/10 transition-all">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h3 className="text-sm text-white font-black uppercase tracking-widest">Direct Signal</h3>
            </div>
            <p className="text-xs text-zinc-500 mb-6 leading-relaxed">
              For professional inquiries, security reports, or partnership technicals regarding Linux Games Alt.
            </p>
            <p className='text-white text-sm italic'>Email relay temporarily offline</p>
          </div>

          <div className="p-8 rounded-3xl bg-white/2 border border-white/5 hover:border-white/10 transition-all">
            <div className="flex items-center gap-4 mb-4">
              <RiHashtag size={24} className="text-zinc-400" />
              <h3 className="text-sm text-white font-black uppercase tracking-widest">Social Feed</h3>
            </div>
            <p className="text-xs text-zinc-500 mb-6 leading-relaxed">
